...
public class This_Main {
    public static void main(String[] args) {
        ...
        This_Car car1 = new This_Car("GV60"); // 첫번째 생성자 호출하지만
        // this(model, "Blue", 50000000);를
        // 통해 다시 세번째 생성자 를 호출하고 난 뒤에 첫번째 생성자 라고 메세지줌
        ...
        This_Car car2 = new This_Car("GV70", "Red");
        ...
        This_Car car3 = new This_Car("GV80", "Black", 120000000);
