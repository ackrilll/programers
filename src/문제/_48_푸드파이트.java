...
발상
1. int 배열 매개변수 -> String 리턴
2. food[1]~food[3] 원소들 2로 나누어서 num 에 담음
3. 1,2,3을 num 만큼 더하고 cur_str 갱신
4. food[3]까지 반복하고 cur_str = cur_str +"0"+cur_str 해줌
*/
class Solution48{
...
public class _48_푸드파이트 {
    public static void main(String[] args) {
        int[] food = {1, 3, 4, 6};
        String answer = Solution48.solution(food);
