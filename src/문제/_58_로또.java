...
발상
1. int 배열 2개-> int 배열 리턴
2. lottos 에서 0의 갯수 -> zeroNum 변수에 담음
3. 최고 순위 ->  lottos와 win_nums 비교 해서 같은 숫자를 correct 변수에 담고 zeroNum 만큼 더해줌 switch-case로 등수 결정
4. 최저 순위 -> lottos와 win_nums 비교 해서 같은 숫자를 correct 변수에 담아 switch-case로 등수 결정
*/
class Solution58{
...
public class _58_로또 {
    public static void main(String[] args) {
        ...
        int[] answer = Solution58.solution(lottos,win_nums);
